...
WiselyAndHealthy offers a solution for an existing problem, as long as the problem exists our solution has a good reason to exist. “Nearly 23 million girls drop out of school annually after they start their periods and only 36% of its 355 million menstruating females use napkins (the remaining use old cloth, rags, husk or ash to manage the flow)” according to BBC*.
...
We think on this kind of hackathon and challenge there is no place for being proud of accomplishment. It is really sad that in the world inequalities and discriminations exist based on human biology and the natural process of women’s bodies. 
